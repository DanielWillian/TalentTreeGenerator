...
TalentDictionaryLevel6::TalentDictionaryLevel6()
{
	...
	dictEntries.push_back(new TalentDictEntry{HEALTH_REGEN, "*", BASE, {1.05f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{MANA_REGEN, "*", BASE, {1.05f, 1.3f}});
	...
	dictEntries.push_back(new TalentDictEntry{DODGE_CHANCE, "*", BASE, {1.05f, 1.2f}});
	dictEntries.push_back(new TalentDictEntry{RESISTANCE, "*", BASE, {1.05f, 1.1f}});
	dictEntries.push_back(new TalentDictEntry{HIT_CHANCE, "*", BASE, {1.05f, 1.1f}});
	dictEntries.push_back(new TalentDictEntry{CRITICAL_CHANCE, "*", BASE, {1.05f, 1.2f}});
	dictEntries.push_back(new TalentDictEntry{CRITICAL_AMP, "*", BASE, {1.05f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{SINGLE_TARGET_DAMAGE, "*", BASE, {1.2f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{AREA_OF_EFFECT_SIZE, "*", BASE, {1.2f, 1.35f}});
	dictEntries.push_back(new TalentDictEntry{AREA_OF_EFFECT_DAMAGE, "*", BASE, {1.2f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{DIRECT_DAMAGE, "*", BASE, {1.2f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{OVER_TIME_DAMAGE, "*", BASE, {1.2f, 1.3f}});
	dictEntries.push_back(new TalentDictEntry{DURATION_OF_DOT, "*", BASE, {1.2f, 1.3f}});
